...
const na53Nq = () => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield axios_1.default.get(`https://api.binance.com/api/v3/klines?symbol=LINAUSDT&interval=1m&limit=1000`);
    const kline = {
        open: [],
        high: [],
        low: [],
    ...
    console.log(core_1.ema([kline.close, 0], 12).slice(-10));
});
na53Nq();
